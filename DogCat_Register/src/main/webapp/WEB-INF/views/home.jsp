    ...
    <section class="mainAnimal notice">
        ...
        <div class="notice__container">
            <div class="notice-card-left">
                <div class="notice-card heightx1" style='background-image: url("images/main/notice3.jpg");'>
                ...
                <div class="notice-card heightx1" style='background-image: url("images/main/notice2.jpg");'>
                    <div class="notice__content">
            ...
            <div class="notice-card-right">
                <div class="notice-card heightx2"  style='background-image: url("images/main/notice1.jpg");'>
                    <div class="notice__content ">
