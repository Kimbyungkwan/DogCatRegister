...
<body>
    ...
    <section class="mainAnimal notice">
        ...
        <div class="notice__container">
            <div class="notice-card heightx1">
            ...
            <div class="notice-card heightx1">
                <div class="notice__content">
                    ...
                    <p class="notice__content-desc">해당하는 반려동물을 등록하지 않으면, 동물보호법에 따라 최대 100만원의 벌금을 지불해야 합니다! 자진 신고 기간이 끝나서 9월부터는 지역별로 미등록자와 동물 정보 변경 미신고자를 집중단속 한다고 해요.</p>
                </div>
            </div>
            <div class="notice-card">
                <div class="notice__content heightx2">
